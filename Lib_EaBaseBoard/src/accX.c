...
//#define ACC_ADDR_CTL1   0x18 // ZDA = 1, THOPT = 0
//#define ACC_ADDR_CTL2   0x19 // set to 0
//#define ACC_ADDR_LDTH   0x1A // set to 0x07
...
//#define ACC_MCTL_GLVL(g) ((g) << 2) // g-range
//
//#define ACC_STATUS_DRDY 0x01
//#define ACC_STATUS_DOVR 0x02
//#define ACC_STATUS_PERR 0x04
//#define ACC_POLARITY 0x00
//#define ACC_THRESHOLD 0x07 // roughly 0.435g
//#define ACC_AXES 0x20 // absolute threshold, disable z-axis
//
//
///******************************************************************************
...
//}
//
//static uint8_t getIntStatus(void)
//{
//    uint8_t buf[1];
//
//    buf[0] = ACC_ADDR_DETSRC;
//    I2CWrite(ACC_I2C_ADDR, buf, 1);
//    I2CRead(ACC_I2C_ADDR, buf, 1);
//
//    return buf[0];
...
//}
//
//static void setAxes(uint8_t axes)
//{
//    uint8_t buf[2];
//
//    buf[0] = ACC_ADDR_CTL1;
...
//}
//
//static void setPolarity(uint8_t polarity)
//{
//    uint8_t buf[2];
//
//    buf[0] = ACC_ADDR_CTL2;
...
//
//    setThreshold(ACC_THRESHOLD);
//    setAxes(ACC_AXES);
//    setPolarity(ACC_POLARITY);
//}
//
///******************************************************************************
// *
...
//    mctl = getModeControl();
//
//    mctl &= ~(0x03 << 0); // preserve the other bits, only 0 the 2 rightmost bits using bitwise AND
//    mctl |= ACC_MCTL_MODE(mode); // bitwise OR with given mode
//
//    setModeControl(mctl);
//}
//
